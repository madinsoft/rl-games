...
viz = EsVizu('loss_value', 'episode_reward', 'running_reward')
while True:  # Run until solved
    ...
    with tf.GradientTape() as tape:
        for timestep in range(1, max_steps_per_episode):
            ...
            state = tf.convert_to_tensor(state) / 5
        ...
        print(episode_count, 'loss_value', loss_value.numpy().tolist(), episode_reward, running_reward)
        viz(loss_value / 100, episode_reward, running_reward)
