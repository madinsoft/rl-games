...
#     qmodel = Sequential()
#     qmodel.add(Dense(units=4, kernel_initializer='uniform', activation='relu', input_dim=4))
#     qmodel.add(Dense(units=2, kernel_initializer='uniform', activation='relu'))
#     qmodel.add(Dense(units=1, kernel_initializer='uniform', activation='relu'))
