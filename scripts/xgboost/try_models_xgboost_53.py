...
from models.xgboost_model_one import XGModelOne
...
action_possible_values = list(range(4))
trans = LabelTransformer(action_possible_values)
xg_model = XGModelOne(trans)
